namespace DotNetRetry.Unit.Tests.Rules.Templates.Exponential.FunctionBodyTests
{
    ...
    public class WaitTime
    {
        ...
        public void ShouldEqualToExpectedValueForFormula(int retries, int seconds, int expected)
        {
            ...
            var functionBody = new FunctionBody(retriableMock.Object, randomMock.Object, waitableFactoryMock.Object);
            functionBody.GetType().GetField("_count", System.Reflection.BindingFlags.NonPublic |
                System.Reflection.BindingFlags.Instance)?
                .SetValue(functionBody, retries);
